...
ggplot(df, aes(x=turnout, group=VoteCate)) + 
    ...
    labs(x="County voters as percentage of 18 years and older population",
         title="Flexible Voting Laws Increase Turnout during 2016 General Election",
         subtitle="Ease of voting determined by restrictiveness of state voter ID laws, number of early voting days, and mail-in or absentee ballot provisions. Alaska excluded",
         caption="Sources: Population and election data from U.S. Census. Voting laws from National Council of State Legislatures.") +
