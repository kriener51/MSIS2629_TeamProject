...
Screenshots are posted below and the interactive dashboard can be found [here](https://public.tableau.com/profile/neville.fernandes#!/vizhome/Felonswithvotemargins/Dashboard1):

![Actual Election Results for swing states.](results_no-felons.PNG)

![Potential Election Results with increased turnout due to felon re-enfranchisement.](results_yes-felons.PNG)
