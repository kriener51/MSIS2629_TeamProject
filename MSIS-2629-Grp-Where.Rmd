...
This datafeed file comes from a github site: https://github.com/votinginfoproject/VIP-feed-information-project/blob/master/datafeed.txt Its a JSON file and it would probably be better to read it directly from github but I don't know how I would do that without reading the entire web page and having to deal with all of that html junk as well.
...
But the bigger issue involves getting the loop to keep going even if a file download fails...There are 237 urls, and I only got 15 in my list because of a 404 error.
